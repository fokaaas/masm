...
.data
	StanislavPasswordString			db "fYLGwTA", 0
	StanislavKeyPasswordString		db "5--4552", 0
...
Handler proc WindowHandle:dword, Unit:dword, WordPar:dword, LonPar:dword
	.if Unit == WM_COMMAND
		.if WordPar == IDOK
			...
			MOV EBX, offset StanislavKeyPasswordString
			MOV ESI, offset StanislavPasswordDecodedString
			MOV EDI, offset StanislavFieldPasswordString
			...
			invoke lstrcmp, offset StanislavPasswordString, offset StanislavPasswordDecodedString
